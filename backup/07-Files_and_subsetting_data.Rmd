...
- Download the file [Liverpool_beaches.csv](https://www.cgr.liv.ac.uk/illum/NEOFworkshops_5bfa93ca0482d69d/Intro_to_R/data/Liverpool_beaches.csv) into "Chapter_7". 
...
Download [Global_eco_footprint.tsv](https://cgr.liv.ac.uk/illum/NEOFworkshops_5bfa93ca0482d69d/Intro_to_R/data/Global_eco_footprint.tsv) into your "Chapter_7". This file contains The ecological footprint measures the ecological assets that a given population requires to produce the natural resources it consumes.
...
To practice subsetting __data frames__ with square brackets we will __read__ in a new file called - [parks_biodiveristy.csv](https://cgr.liv.ac.uk/illum/NEOFworkshops_5bfa93ca0482d69d/Intro_to_R/data/parks_biodiveristy.csv). This contains the number of different species of various groups (Bird, Mammal, etc.) in US national parks. Data can be found:
