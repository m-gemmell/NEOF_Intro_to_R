...
<center>
![](figures/palette.png){style="width:200px; background: white; border-radius:5px; border: 5px white solid"}
</center>
...
Create and use the directory "Chapter_12-14" as the working directory for this chapter. 
Additionally, create a new script called "Histograms_n_line_graphs.R" for this chapter.

## Histogram
<center>
![](figures/histogram.png){style="width:200px; background: white; border-radius:5px; border: 5px white solid"}
</center>
...
You will notice that the histogram is not very interesting. There are 8 bars all of equal size. This is because we plotted the numbers 1-40 so numbers 1-5 are counted in the first bar/bin, 6-10 in the second bar/bin and so forth. To get a more interesting histogram we will create a more interesting __vector__.

### EU cities
<center>
![](figures/barcelona.png){style="width:150px; background: white; border-radius:5px; border: 5px white solid"}
</center>

Histograms are good to see the numerical distribution of data. 
Next we are going to look at the number of cities (with greater than 300,000 population) in EU countries (https://en.Wikipedia.org/wiki/List_of_cities_in_the_European_Union_by_population_within_city_limits).
...
With that histogram we can see that most EU countries have 1-5 cities with a few having a much larger amount. 

### EU populations
<center>
![](figures/copenhagan.png){style="width:150px; background: white; border-radius:5px; border: 5px white solid"}
</center>

Most of the time you will not be working with just __vectors__.
Therefore, we'll make a __data frame__ containing the number of EU cities and the population of the EU countries.
...
### EU population and cities ratio
<center>
![](figures/edinburgh.png){style="width:150px; background: white; border-radius:5px; border: 5px white solid"}
</center>
...
<center>
![](figures/RStudio_plot_pane_arrows.png){style="width:400px; border-radius:5px"}
</center>

## Line graphs
<center>
![](figures/line_graph.png){style="width:200px; background: white; border-radius:5px; border:5px white solid"}
</center>

Line graphs are perfect for showing change over time. Knowing this we'll go back to a data set we have touched before, the file "honey_bee.tsv" from [Chapter 9](#honeybeechap). This file showed the number of Honey Bee colonies in various US states from 2015-2018.

### Read in data
<center>
![](figures/read.png){style="width:150px; background: white; border-radius:5px"}
</center>

The first step is to __read__ in the data from the "Chapter_7-9" directory. Once the __data frame__ is created we will remove all non 2017 & 2018 information.

__Note__: The `../` below represents going up one directory. I.e. going up from your current working directory ("Chapter_12-14") to the main directory so it can be directed to "Chapter_8_files".

```{r eval=FALSE}
bee_colonies_df <- read.csv("../Chapter_7-9/honey_bee.tsv", 
...
<center>
![](figures/paint_brush.png){style="width:150px; background: white; border-radius:5px"}
</center>
...
<center>
![](figures/lines_black.png){style="width:150px; background: white; border-radius:5px; border: 5px white solid"}
</center>
...
### Axis limits
<center>
![](figures/limits.png){style="width:150px; background: white; border-radius:5px; border: 5px white solid"}
</center>

To fix this we need to make sure all the data is within the graph. When the `plot()` __function__ was run it created the y limits based on Minnesota which has a maximum and minimum value of 136000 and 27000. Unfortunately some of the other states barely fit in this range.
...
### Axis labels
<center>
![](figures/axis_labels.png){style="width:150px; background: white; border-radius:5px; border: 5px white solid"}
</center>
...
- `at = bee_colonies_df$time_point`: This indicates where the points tick marks will be drawn.
...
### Plot titles
<center>
![](figures/plot_title.png){style="width:150px; background: white; border-radius:5px; border: 5px white solid"}
</center>
...
### Line colours
<center>
![](figures/lines.png){style="width:150px; background: white; border-radius:5px; border: 5px white solid"}
</center>
...
### Plot legend
<center>
![](figures/legend.png){style="width:200px; background: white; border-radius:5px; border: 5px white solid"}
</center>
