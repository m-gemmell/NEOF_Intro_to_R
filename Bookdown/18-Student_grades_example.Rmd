...
<center>
![](figures/grades.png){style="width:200px; background:white; border-radius:15px"}
</center>

In this section we are going to go through analysing datasets of student grades. 

## The student grades data
<center>
![](figures/data.png){style="width:200px; background: white; border-radius:5px; border: white solid 5px"}
</center>

Download the five following files into your directory "Chapter_17-18".
...
## Analysis script
<center>
![](figures/hashtag2.png){style="width:200px; background: white; border-radius:5px; border: white solid 5px"}
</center>

Before carrying on I would suggest to set your working directory into the directory "Chapter_17-18".

Now create a new R Script and save it as "student_grades.R" in the "Chapter_17-18" directory. It is useful to have your scripts close to their relevant data.

Ensure you use annotations and code sections to keep your script organised and tidy.

One extra tip: I normally like to keep a `setwd()` command at the top of my R Scripts so the script will set itself to the correct working directory. I copy the relevant command from the __console__ after I set the working directory via the RSudio interface.

## Reading in and preprocessing the data
<center>
![](figures/r_read.png){style="width:200px; border-radius:15px; background:white"}
</center>
...
<center>
![](figures/combine.png){style="width:200px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
<center>
![](figures/r_save.png){style="width:200px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
That is the last edit we will do to our __data frame__ so lets __save__ it.
```{r eval=FALSE}
save(student_grades_df, file = "student_grades_df")
```
...
<center>
![](figures/tip_box.png){style="width:200px; background:white; border-radius:10px"}
</center>
