# (PART\*) Stats {.unnumbered}

# Basic stats {#basicstats}
<center>
![](figures/basic_stats.png){style="width:200px; background: white; border-radius:5px; border: white solid 5px"}
</center>

In this chapter we'll learn how to carry out some basic stats. This will involve linear regressions and some t-tests.

Create and use the directory "Chapter_15-16" as the working directory for this chapter. Additionally create a new script called "Stats.R" for this chapter.

Before we continue just a reminder about [annotations](#annotations) and [code sections](#codesections).

## Linear regression
<center>
![](figures/linear_regression.png){style="width:200px; background:white; border-radius:15px"}
</center>
...
### Fish market dataset
<center>
![](figures/bream.png){style="width:300px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
### Linear model
<center>
![](figures/lm.png){style="width:200px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
## t-test
<center>
![](figures/scale.png){style="width:200px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
### t-test comparison
<center>
![](figures/five_percent.png){style="width:200px; background: white; border-radius:5px; border: white solid 5px"}
</center>

Will statistical analysis backup our visual findings?

We can carry out a t-test with the __function__ `t.test()`. For this we need to provide the __function__ with the two __numerical vectors__ we'd like to compare.
```{r eval=FALSE}
...
<center>
![](figures/r_toolbox.png){style="width:200px; background:white; border-radius:15px"}
</center>
...
### Table
<center>
![](figures/table_ikea.png){style="width:200px; background: white; border-radius:5px; border: white solid 5px"}
</center>
...
## Further resources
<center>
![](figures/resources.png){style="width:200px; background: white; border-radius:5px; border: white solid 5px"}
</center>
