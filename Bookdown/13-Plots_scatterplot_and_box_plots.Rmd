...
<center>
![](figures/large_brush.png){style="width:200px; background:white; border-radius:5px"}
</center>

Last chapter we learnt how to make Histograms and Line graphs. In this chapter it is Scatter plots and Box plots.

Continue using the directory "Chapter_12-14" as the working directory.

## Scatter plot
<center>
![](figures/Scatterplot_2.png){style="width:200px; background:white; border-radius:5px; border: white solid 5px"}
</center>
...
Additionally we will not provide the option names `x = ` and `y = `. __Functions__ have an order to their options so if you leave out the option names but provide options (in this case __vectors__) it will use the options in the function's default order. 
In the case of `plot()` it will take the first option as `x = ` and the second option as `y = `. It is common for plotting functions to take x first then y.
...
### Animal sizes data
<center>
![](figures/blue_whale.png){style="width:200px; background:white; border-radius:5px"}
</center>
...
Download the [animal_sizes.csv](https://neof-workshops.github.io/R_j4c0xh/downloads/animal_sizes.csv) file into your "Chapter_12-14" directory.

### Read in animal data
<center>
![](figures/reading_glasses.png){style="width:150px; background:white; border-radius:5px"}
</center>
...
### Average mass and max mass
<center>
![](figures/hippo.png){style="width:150px; background:white; border-radius:5px"}
</center>
...
### Average mass and length
<center>
![](figures/elephant.png){style="width:150px; background:white; border-radius:5px"}
</center>
...
### Plot section zoom
<center>
![](figures/zoom.png){style="width:150px; background:white; border-radius:5px"}
</center>
...
### Colour points by metadata
<center>
![](figures/coloured_points.png){style="width:150px; background:white; border-radius:5px"}
</center>
...
## Factors
<center>
![](figures/key_factor.png){style="width:175px; background:white; border-radius:5px; border: 5px white solid"}
</center>
...
### What are levels? 
<center>
![](figures/level.png){style="width:150px; background:white; border-radius:15px"}
</center>
...
### Code example
<center>
![](figures/keyboard_bfx.png){style="width:150px; background:white; border-radius:5px"}
</center>
...
### Level orders
<center>
![](figures/reorder.png){style="width:150px; background:white; border-radius:5px; border: white 5px solid"}
</center>
...
<center>
![](figures/scatterplot_colours_shapes.png){style="width:150px; background:white; border-radius:5px; border: white 5px solid"}
</center>
...
## Box plot
<center>
![](figures/boxplot.png){style="width:200px; background:white; border-radius:5px"}
</center>
...
First download the [penguin.tsv](https://neof-workshops.github.io/R_j4c0xh/downloads/penguin.tsv) file into your "Chapter_12-14" directory.
...
### Body mass boxplot
<center>
![](figures/penguin_unix.png){style="width:150px; background:white; border-radius:5px; border: white 5px solid"}
</center>
...
### Split x axis by two groupings
<center>
![](figures/boxplot_2_axis_groups.png){style="width:150px; background:white; border-radius:5px; border: white 5px solid"}
</center>
...
### Example boxplots
<center>
![](figures/penguin_3.png){style="width:150px; background:white; border-radius:5px; border: white 5px solid"}
</center>
...
### Final boxplot
<center>
![](figures/penguin_2.png){style="width:150px; background:white; border-radius:5px; border: white 5px solid"}
</center>
...
<center>
![](figures/r_save.png){style="width:200px; background: white; border-radius:5px; border: 5px solid white"}
</center>
...
<center>
![](figures/display_png.png){style="width:200px; background: white; border-radius:5px; border: 5px solid white"}
</center>
