...
Let's do it one more time with the Global ecological footprint info. First __read__ in the file again in case you do not have it. Then create a total sales column and then finally transpose the __data frame__:
```{r eval=FALSE}
#Read in
global_eco_footprint_df <- read.csv("Global_eco_footprint.tsv", 
                                 row.names = 1, sep = "\t", 
