...
To practice subsetting __data frames__ with square brackets we will __read__ in a new file called - [parks.csv](https://cgr.liv.ac.uk/illum/NEOFworkshops_5bfa93ca0482d69d/Intro_to_R/data/parks.csv). This contains the number of different species of various groups (Bird, Mammal, etc.) in US national parks. Data can be found:
