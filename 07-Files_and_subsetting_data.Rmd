...
We now know how to __read__ in a csv file with `read.csv`, now let us __read__ in the tab separated file, [Clothing_stores.txt](https://cgr.liv.ac.uk/illum/NEOFworkshops_5bfa93ca0482d69d/Intro_to_R/data/Clothing_stores.txt), with `read.csv`. As before first download the files into your "Chapter_7" directory and look at the file contents before __reading__ them in. It contains the sales figures of fictional clothing stores through the seasons.
