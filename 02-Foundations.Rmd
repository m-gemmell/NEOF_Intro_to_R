...
__Q1__: ________ are symbols that allow you to carry out common R tasks such as addition and multiplication. `r longmcq(opts_p)`
...
__Q2__: The assignment operator is: ________ `r longmcq(opts_p)`
...
__Q3__: Hash tags (`#`) can be used to create human readable ________ `r longmcq(opts_p)`
...
__Q4__: `sqrt` is a R ________ `r longmcq(opts_p)`
...
__Q5__: ________ can be assigned as R Variables `r longmcq(opts_p)`