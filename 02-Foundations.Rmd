...
<center>
![](figures/foundational.png){style="width:200px"}
</center>
...
R __Functions__ allow the user to carry out specific tasks. R has many inbuilt __functions__ but you can also create your own. Currently we will look at inbuilt functions.
